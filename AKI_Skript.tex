...
\newcommand{\greleq}{\leqslant_{\mathcal{L}}}
\newcommand{\grereq}{\leqslant_{\mathcal{R}}}
\newcommand{\grejeq}{\leqslant_{\mathcal{J}}}
\newcommand{\greheq}{\leqslant_{\mathcal{H}}}
\newcommand{\gredeq}{\leqslant_{\mathcal{D}}}
\newcommand{\greyeq}{\leqslant_{\mathcal{Y}}}
...
\subsubsection{Definition Greensrelations}	
	...
	\begin{align*}
		\mathcal L \subseteq M \times M: x \grel y &\iff Mx = My \iff x,y \text{ erzeugen identische Linksideale} \\
		\mathcal R \subseteq M \times M: x \grer y &\iff xM = yM \iff x,y \text{ erzeugen identische Rechtsideale} \\
	...
	Sowie 
	\begin{align*}
	\mathcal L \subseteq M \times M: x \greleq y &\iff Mx = My \iff x,y \text{ erzeugen identische Linksideale} \\
	\mathcal R \subseteq M \times M: x \grereq y &\iff xM = yM \iff x,y \text{ erzeugen identische Rechtsideale} \\
	\mathcal J \subseteq M \times M: x \grejeq y &\iff MxM = MyM \\ 
	\mathcal H = \mathcal L \cap \mathcal R: x \greh y &\iff x \grel y \text{ und } x \grer y
	\end{align*}
	 ...
	 \begin{figure}[h!]
	 	...
	 	\draw[-] (LDR) -- (Y) node[midway,sloped,above,rotate=0] {$\subseteq$};
	 	\end{tikzpicture}

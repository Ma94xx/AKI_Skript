...
\subsection{Allgemeines}
	...
	In diesem Kapitel soll der Teil $\fo[\leq] \implies \starfree$ gezeigt werden. Also, dass für eine Sprache $L \subseteq \sigstern$, die in $\fo[\leq]$ definierbar ist,  $L \in \sf(\sigstern)$ folgt. 
...
\subsubsection{Semantik}
	...
	\end{gather*}
	$$\llbracket \exists x_n : \varphi \rrbracket_V \in \{ \overline{(w, \sigma)} \in \mathcal{N}_V \mid \exists p : 1 \leq p \leq |w| \land \overline{(w, \sigma[x_n \to p])} \in \llbracket \varphi \rrbracket_{V \cup [x_n]} \}$$

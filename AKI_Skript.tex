...
\subsubsection{Beweis des Lemmas}
	Dieses Lemma gilt nach Lemma 1 und Lemma 2, wegen: $$L_A c L'_A = L_a c \sigstern \cap \sigstern c L'_A \cap \aast c \aast$$
	\bewiesen
...
\begin{align*}
	...
	\end{align*}
\subsubsection{Beweis des Lemmas}
Gilt durch Lemma 1, Lemma 2 und Satz~\ref{sec:ltl_hn}, welcher im Folgenden gezeigt wird.
...
\subsubsection{Beweis des Satzes}
	...
	Es gilt $$h\inv(n) \cap c\sigstern c \aast = \bigcup_{q\cdot c\cdot r = n} L_q c (h\inv(r) \cap \aast) $$ mit $L_q = \{cw \in c \sigstern \mid h(cw)c = qc\}$. Zeige also nur $\forall q : L_q \in \ltl$, dann folgt der Satz mit Lemma 3.

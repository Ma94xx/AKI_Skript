...
\subsubsection{Grundlagen Homomorphismus}
	Eine Abbildung $\varphi: G \to F$ heißt Homomorphismus falls $\forall g,h \in G : \varphi(gh) = \varphi(g)\varphi(h)$ \\
...
\subsubsection{Satz zu Normalteilern}
	...
	\begin{enumerate}[label=\arabic*)]
		...
		\item Es existiert ein Homomorphismus $\varphi: G \to F$ mit $ker(\varphi) = \{g \in G \mid \varphi(g)= 1\} = H$

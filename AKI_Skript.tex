...
\subsubsection{Definition}
		   ...
		   Dabei ist das $n$-Eck durch folgende Knoten und Kanten definiert: 
		   \begin{align*}
		   ...
		   \begin{align*}
		   	&f: \mathbb{Z}/n\mathbb{Z} \iso \mathbb{Z}/n\mathbb{Z},\, wobei\\
		   	&f(i+1) \in \{f(i)+1, f(i)-1\}\, gilt.
		   \end{align*}
...
\begin{align*}
	...
	\delta(j) & = -j \\
	\sigma^2 & = 1\\
	\delta\overline{\delta} & = \overline{\delta}\delta = 1 \\
...
\subsubsection{Definition Greensrelations}	
	...
	Sowie 
	\begin{align*}
	\mathcal L \subseteq M \times M: x \greleq y &\iff Mx \subseteq My \\
	\mathcal R \subseteq M \times M: x \grereq y &\iff xM \subseteq yM \\
	\mathcal J \subseteq M \times M: x \grejeq y &\iff MxM \subseteq MyM 
	\end{align*}

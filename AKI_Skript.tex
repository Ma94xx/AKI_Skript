...
Wir betrachten $\mso$ hier für gerichtete Graphen mit Knotenbeschriftungen, also für Modelle $(V, E ,\lambda)$ mit einer Knotenmenge $V$, einer Kantenmenge $E \subseteq V \times V$ und einer Beschriftung $\lambda : V \to \Sigma$, wobei $\Sigma$ ein endliches Alphabet ist.

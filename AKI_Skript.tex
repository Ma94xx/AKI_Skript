...
\subsubsection{$\fo$-Fragmente} 
	...
	gilt. 
	Hierbei ist der $\sX\sU$-Operator definiert durch  $\varphi(\sX\sU)\psi := \sX(\varphi\sU\psi)$ und es gilt $\sX\varphi = \bot \sX\sU\varphi$, sowie $\varphi\sU\psi = \psi \lor \varphi \land \varphi \sX \sU \psi$. 

...
\begin{document}
	...
	Sei also nun $\synt(L)$ aperiodisch und endlich. Weiter sei $\varphi: \aast \to \synt(L)$ ein surjektiver Hom.. 
	Wir betrachten nun die Elemente, die auf 1 abgebildet werden $A_1 = \{a \in A \mid \varphi(a) = 1\}$.
	Dann folgt aus dem Lemma \ref{Lemma:Schütz}, dass $$\varphi\inv(1) = \aast_1\, ,$$ sowie $\aast_1 \in \starfree(A)$ gilt.
	\newline

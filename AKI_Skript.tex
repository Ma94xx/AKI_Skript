...
\begin{document}
	...
	Sei nun $c\in A$ fest gewählt mit $\varphi(c) \not = 1$. Dann müssen wir nunn zeigen, dass $\varphi\inv(s)c\varphi\inv(r) \in \starfree(A)$ gilt. 
	\newline
	...
	Nun sei $\aast = \bast \cup \bast (c \bast) c \bast$ für $B = A \setminus \{c\}$. Zeige nun $\varphi\inv(p) \cap \bast(c\bast)^\ast c\bast \in \starfree(A)$: 
	\begin{align*}

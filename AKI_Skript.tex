...
\subsubsection{Satz über die Einfachheit von $A_n$}
	Für $n \geq 5$ ist $A_n$ einfach (C.Jordan, 1875).

\subsubsection{Beweis des Satzes}
	Wir wissen durch $A_5 \leq S_5$ und den Satz von Lagrange, dass $[S_5 : A_5] = 2$ und weiter dass $|S_5| = 5! = 120$. Daraus folgt dann dass $|A_5|=60$. 
	Jede Gruppe mit weniger Elementen ist auflösbar. Dies ist einfach aber sehr aufwendig zu zeigen. 
	Wir wissen somit dass $A_5$ die kleinste nichtauflösbare Gruppe und einzige Gruppe mit $60$ Elementen ist. 
	\bewiesen
